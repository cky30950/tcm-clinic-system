 ...
 * 更新：已全面整合所有重複的穴位名稱（包含胸腹正面/側面、背部/側面、下肢/腹部連接處）。
 */
...
(function() {
    ...
    const ACUPOINT_COORDS = {
        ...
        '京骨': [{ x: 0.8717, y: 0.0294 }],
        '金門': [{ x: 0.8819, y: 0.0337 }],
        '髀關': [{ x: 0.8343, y: 0.4402 }],
        '箕門': [{ x: 0.7826, y: 0.4157 }],
        '血海': [{ x: 0.7574, y: 0.3635 }],
        '陰包': [{ x: 0.7790, y: 0.3729 }],
        '伏兔': [{ x: 0.8439, y: 0.3578 }],
        '風市': [{ x: 0.8780, y: 0.3535 }],
        '曲泉': [{ x: 0.7701, y: 0.3174 }],
        '陰谷': [{ x: 0.7788, y: 0.3194 }],
        '陰市': [{ x: 0.8508, y: 0.3253 }],
        '中瀆': [{ x: 0.8785, y: 0.3342 }],
        '復溜': [{ x: 0.7934, y: 0.1643 }],
        '太溪': [{ x: 0.7924, y: 0.1420 }],
        '犢鼻': [{ x: 0.8621, y: 0.2548 }],
        '陽陵泉': [{ x: 0.8857, y: 0.2382 }],
        '足三里': [{ x: 0.8711, y: 0.2224 }],
        '上巨虛': [{ x: 0.8714, y: 0.1870 }],
        '條口': [{ x: 0.8723, y: 0.1643 }],
        '豐隆': [{ x: 0.8785, y: 0.1645 }],
        '下巨虛': [{ x: 0.8721, y: 0.1536 }],
        '外丘': [{ x: 0.8866, y: 0.1547 }],
        '公孫': [{ x: 0.7556, y: 0.0888 }],
        '然谷': [{ x: 0.7718, y: 0.0958 }],
        '水泉': [{ x: 0.7934, y: 0.1089 }],
        '光明': [{ x: 0.8870, y: 0.1290 }],
        '陽輔': [{ x: 0.8851, y: 0.1155 }],
        '懸鐘': [{ x: 0.8875, y: 0.1043 }],
        '跗陽': [{ x: 0.9005, y: 0.1045 }],
        '解谿': [{ x: 0.8756, y: 0.0691 }],
        '衝陽': [{ x: 0.8613, y: 0.0563 }],
        '丘墟': [{ x: 0.8804, y: 0.0608 }],
        '崑崙': [{ x: 0.8984, y: 0.0654 }],
        '梁丘': [{ x: 0.8531, y: 0.3139 }],
        '膝陽關': [{ x: 0.8851, y: 0.2942 }],
        '陰陵泉': [{ x: 0.7634, y: 0.3017 }],
        '膝關': [{ x: 0.7712, y: 0.3221 }],
        '地機': [{ x: 0.7673, y: 0.2678 }],
        '中都': [{ x: 0.7656, y: 0.2253 }],
        '漏谷': [{ x: 0.7731, y: 0.2133 }],
        '蠡溝': [{ x: 0.7689, y: 0.1980 }],
        '築賓': [{ x: 0.7865, y: 0.1988 }],
        '三陰交': [{ x: 0.7778, y: 0.1750 }],
        '交信': [{ x: 0.7871, y: 0.1643 }],
        '陽交': [{ x: 0.8941, y: 0.1540 }],
        '飛揚': [{ x: 0.9055, y: 0.1543 }],
        '中封': [{ x: 0.7712, y: 0.1294 }],
        '商丘': [{ x: 0.7779, y: 0.1255 }],
        '照海': [{ x: 0.7831, y: 0.1222 }],
        '大鐘': [{ x: 0.7979, y: 0.1264 }],
        '隱白': [{ x: 0.7234, y: 0.0816 }],
        '行間': [{ x: 0.7375, y: 0.0927 }],
        '太衝': [{ x: 0.7492, y: 0.1017 }],
        '大都': [{ x: 0.7330, y: 0.0790 }],
        '太白': [{ x: 0.7456, y: 0.0831 }],
        '陷谷': [{ x: 0.8480, y: 0.0471 }],
        '足臨泣': [{ x: 0.8649, y: 0.0429 }],
        '申脈': [{ x: 0.8891, y: 0.0532 }],
        '內庭': [{ x: 0.8340, y: 0.0383 }],
        '俠溪': [{ x: 0.8413, y: 0.0337 }],
        '地五會': [{ x: 0.8544, y: 0.0363 }],
        '仆參': [{ x: 0.9002, y: 0.0412 }],
        '厲兌': [{ x: 0.8211, y: 0.0309 }],
        '足竅陰': [{ x: 0.8323, y: 0.0252 }],
        '至陰': [{ x: 0.8394, y: 0.0250 }],
        '足通谷': [{ x: 0.8487, y: 0.0252 }],
        '束骨': [{ x: 0.8622, y: 0.0274 }],
