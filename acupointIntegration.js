...
(function() {
    ...
    const ACUPOINT_COORDS = {
        ...
        '臑會': [{ x: 0.9316, y: 0.7508 }],
        '臂臑': [{ x: 0.9273, y: 0.7373 }],
        '天府': [{ x: 0.9079, y: 0.7104 }],
        '俠白': [{ x: 0.9136, y: 0.7034 }],
        '消濼': [{ x: 0.9572, y: 0.7196 }],
        '手五里': [{ x: 0.9513, y: 0.6953 }],
        '清冷淵': [{ x: 0.9740, y: 0.6964 }],
        '肘髎': [{ x: 0.9624, y: 0.6796 }],
        '天井': [{ x: 0.9790, y: 0.6888 }],
        '曲池': [{ x: 0.9599, y: 0.6693 }],
        '陽谿': [{ x: 0.9351, y: 0.5473 }],
        '陽池': [{ x: 0.9462, y: 0.5421 }],
        '合谷': [{ x: 0.9297, y: 0.5224 }],
        '少商': [{ x: 0.9132, y: 0.5052 }],
        '三間': [{ x: 0.9318, y: 0.5115 }],
        '二間': [{ x: 0.9319, y: 0.4988 }],
        '中渚': [{ x: 0.9555, y: 0.5093 }],
        '液門': [{ x: 0.9557, y: 0.4962 }],
        '商陽': [{ x: 0.9283, y: 0.4652 }],
        '關衝': [{ x: 0.9453, y: 0.4591 }],
        '少衝': [{ x: 0.9533, y: 0.4682 }],
        '手三里': [{ x: 0.9566, y: 0.6481 }],
        '上廉': [{ x: 0.9549, y: 0.6379 }],
        '下廉': [{ x: 0.9533, y: 0.6289 }],
        '四瀆': [{ x: 0.9700, y: 0.6132 }],
        '溫溜': [{ x: 0.9483, y: 0.5985 }],
        '三陽絡': [{ x: 0.9560, y: 0.5830 }],
        '偏曆': [{ x: 0.9441, y: 0.5758 }],
        '支溝': [{ x: 0.9522, y: 0.5717 }],
        '會宗': [{ x: 0.9572, y: 0.5679 }],
        '外關': [{ x: 0.9501, y: 0.5599 }],
