...
(function() {
    ...
    const ACUPOINT_COORDS = {
        ...
        '人迎': [
            { x: 0.1624, y: 0.8264 }, // 頸部人迎
            { x: 0.8556, y: 0.8131 }  // 上肢人迎（已整合）
        ],
        '扶突': [
            { x: 0.1692, y: 0.8264 }, // 頸部扶突
            { x: 0.8655, y: 0.8148 }  // 上肢扶突（已整合）
        ],
        '水突': [
            { x: 0.1630, y: 0.8149 }, // 頸部水突
            { x: 0.8546, y: 0.7995 }  // 上肢水突（已整合）
        ],
        '天鼎': [
            { x: 0.1761, y: 0.8167 }, // 頸部天鼎
            { x: 0.8688, y: 0.7998 }  // 上肢天鼎（已整合）
        ],
        '氣舍': [{ x: 0.1634, y: 0.8044 }],
        '天突': [
            { x: 0.1528, y: 0.8015 }, // 頸部天突
            { x: 0.8468, y: 0.7827 }  // 上肢天突（已整合）
        ],
        '缺盆': [
            { x: 0.1819, y: 0.8059 }, // 頸部缺盆
            { x: 0.8693, y: 0.7849 }  // 上肢缺盆（已整合）
        ],

        // ==========================================
        // 上肢 (Upper Limb) - 已整合重複穴位
        // ==========================================
        '尺澤': [
            { x: 0.7580, y: 0.7591 },
            { x: 0.2408, y: 0.6391 }
        ...
        '臑會': [
            { x: 0.9316, y: 0.7508 }, // 上肢第一臑會
            { x: 0.5317, y: 0.7287 }  // 上肢第二臑會（已整合）
        ],
        '臂臑': [
            { x: 0.9273, y: 0.7373 }, // 上肢第一臂臑
            { x: 0.5459, y: 0.7129 }, // 上肢第二臂臑（已整合）
            { x: 0.9043, y: 0.7731 }  // 上肢第三臂臑（已整合）
        ],
        '天府': [
            { x: 0.9079, y: 0.7104 }, // 上肢第一天府
            { x: 0.2311, y: 0.7088 }  // 上肢第二天府（已整合）
        ],
        '俠白': [
            { x: 0.9136, y: 0.7034 }, // 上肢第一俠白
            { x: 0.2329, y: 0.6987 }  // 上肢第二俠白（已整合）
        ],
        '消濼': [
            { x: 0.9572, y: 0.7196 }, // 上肢第一消濼
            { x: 0.5340, y: 0.6812 }  // 上肢第二消濼（已整合）
        ],
        '手五里': [
            { x: 0.9513, y: 0.6953 }, // 上肢第一手五里
            { x: 0.5501, y: 0.6548 }  // 上肢第二手五里（已整合）
        ],
        '清冷淵': [
            { x: 0.9740, y: 0.6964 }, // 上肢第一清冷淵
            { x: 0.5350, y: 0.6391 }  // 上肢第二清冷淵（已整合）
        ],
        '肘髎': [
            { x: 0.9624, y: 0.6796 }, // 上肢第一肘髎
            { x: 0.5498, y: 0.6321 }  // 上肢第二肘髎（已整合）
        ],
        '天井': [
            { x: 0.9790, y: 0.6888 }, // 上肢第一天井
            { x: 0.5357, y: 0.6248 }  // 上肢第二天井（已整合）
        ],
        '曲池': [
            { x: 0.9599, y: 0.6693 }, // 上肢第一曲池
            { x: 0.5575, y: 0.6217 }  // 上肢第二曲池（已整合）
        ],
        '陽谿': [
            { x: 0.9351, y: 0.5473 }, // 上肢第一陽谿
            { x: 0.5856, y: 0.4920 }  // 上肢第二陽谿（已整合）
        ],
        '陽池': [
            { x: 0.9462, y: 0.5421 }, // 上肢第一陽池
            { x: 0.5720, y: 0.4840 }  // 上肢第二陽池（已整合）
        ],
        '合谷': [
            { x: 0.9297, y: 0.5224 }, // 上肢第一合谷
            { x: 0.5960, y: 0.4693 }  // 上肢第二合谷（已整合）
        ],
        '三間': [
            { x: 0.9318, y: 0.5115 }, // 上肢第一三間
            { x: 0.6013, y: 0.4540 }  // 上肢第二三間（已整合）
        ],
        '二間': [
            { x: 0.9319, y: 0.4988 }, // 上肢第一二間
            { x: 0.6044, y: 0.4424 }  // 上肢第二二間（已整合）
        ],
        '中渚': [
            { x: 0.9555, y: 0.5093 }, // 上肢第一中渚
            { x: 0.5733, y: 0.4477 }  // 上肢第二中渚（已整合）
        ],
        '液門': [
            { x: 0.9557, y: 0.4962 }, // 上肢第一液門
            { x: 0.5756, y: 0.4359 }  // 上肢第二液門（已整合）
        ],
        '商陽': [
            { x: 0.9283, y: 0.4652 }, // 上肢第一商陽
            { x: 0.6142, y: 0.4086 }  // 上肢第二商陽（已整合）
        ],
        '關衝': [
            { x: 0.9453, y: 0.4591 }, // 上肢第一關衝
            { x: 0.5883, y: 0.3979 }  // 上肢第二關衝（已整合）
        ],
        '少衝': [
            { x: 0.9533, y: 0.4682 }, // 上肢第一少衝
            { x: 0.5798, y: 0.4103 }  // 上肢第二少衝（已整合）
        ],
        '手三里': [
            { x: 0.9566, y: 0.6481 }, // 上肢第一手三里
            { x: 0.5620, y: 0.6026 }  // 上肢第二手三里（已整合）
        ],
        '上廉': [
            { x: 0.9549, y: 0.6379 }, // 上肢第一上廉
            { x: 0.5637, y: 0.5900 }  // 上肢第二上廉（已整合）
        ],
        '下廉': [
            { x: 0.9533, y: 0.6289 }, // 上肢第一下廉
            { x: 0.5660, y: 0.5780 }  // 上肢第二下廉（已整合）
        ],
        '四瀆': [
            { x: 0.9700, y: 0.6132 }, // 上肢第一四瀆
            { x: 0.5507, y: 0.5579 }  // 上肢第二四瀆（已整合）
        ],
        '溫溜': [
            { x: 0.9483, y: 0.5985 }, // 上肢第一溫溜
            { x: 0.5706, y: 0.5458 }  // 上肢第二溫溜（已整合）
        ],
        '三陽絡': [
            { x: 0.9560, y: 0.5830 }, // 上肢第一三陽絡
            { x: 0.5592, y: 0.5290 }  // 上肢第二三陽絡（已整合）
        ],
        '偏歷': [
            { x: 0.9441, y: 0.5758 }, // 上肢第一偏歷
            { x: 0.5751, y: 0.5237 }  // 上肢第二偏歷（已整合）
        ],
        '支溝': [
            { x: 0.9522, y: 0.5717 }, // 上肢第一支溝
            { x: 0.5639, y: 0.5180 }  // 上肢第二支溝（已整合）
        ],
        '會宗': [
            { x: 0.9572, y: 0.5679 }, // 上肢第一會宗
            { x: 0.5577, y: 0.5143 }  // 上肢第二會宗（已整合）
        ],
        '外關': [
            { x: 0.9501, y: 0.5599 }, // 上肢第一外關
            { x: 0.5664, y: 0.5078 }  // 上肢第二外關（已整合）
        ],
        '天窗': [{ x: 0.8765, y: 0.8196 }],
        '肩井': [
            { x: 0.8933, y: 0.8044 }, // 上肢肩井
            { x: 0.4914, y: 0.8249 }  // 背部肩井（已整合）
        ],
        '氣舍': [
            { x: 0.8537, y: 0.7853 }, // 上肢氣舍
            { x: 0.1634, y: 0.8044 }  // 頸部氣舍（已整合）
        ],
        '肩髎': [
            { x: 0.9153, y: 0.7797 }, // 上肢第一肩髎
            { x: 0.5305, y: 0.7978 }  // 上肢第二肩髎（已整合）
        ],
        '璇璣': [
            { x: 0.8422, y: 0.7731 }, // 上肢璇璣
            { x: 0.1528, y: 0.7915 }  // 胸腹璇璣（已整合）
        ],
        '神藏': [
            { x: 0.8376, y: 0.7419 }, // 上肢神藏
            { x: 0.1692, y: 0.7588 }  // 胸腹神藏（已整合）
        ],
        '屋翳': [
            { x: 0.8471, y: 0.7419 }, // 上肢屋翳
            { x: 0.1849, y: 0.7610 }  // 胸腹屋翳（已整合）
        ],
        '周榮': [
            { x: 0.8624, y: 0.7401 }, // 上肢周榮
            { x: 0.1979, y: 0.7673 }  // 胸腹周榮（已整合）
        ],
        '玉堂': [
            { x: 0.8245, y: 0.7272 }, // 上肢玉堂
            { x: 0.1531, y: 0.7423 }  // 胸腹玉堂（已整合）
        ],
        '靈墟': [
            { x: 0.8317, y: 0.7270 }, // 上肢靈墟
            { x: 0.1692, y: 0.7429 }  // 胸腹靈墟（已整合）
        ],
        '膺窗': [
            { x: 0.8404, y: 0.7261 }, // 上肢膺窗
            { x: 0.1855, y: 0.7451 }  // 胸腹膺窗（已整合）
        ],
        '胸鄉': [
            { x: 0.8558, y: 0.7253 }, // 上肢胸鄉
            { x: 0.1983, y: 0.7504 }  // 胸腹胸鄉（已整合）
        ],
        '膻中': [
            { x: 0.8196, y: 0.7106 }, // 上肢膻中
            { x: 0.1531, y: 0.7268 }  // 胸腹膻中（已整合）
        ],
        '神封': [
            { x: 0.8266, y: 0.7104 }, // 上肢神封
            { x: 0.1694, y: 0.7268 }  // 胸腹神封（已整合）
        ],
        '乳中': [
            { x: 0.8355, y: 0.7084 }, // 上肢乳中
            { x: 0.1857, y: 0.7269 }  // 胸腹乳中（已整合）
        ],
        '天池': [
            { x: 0.8436, y: 0.7095 }, // 上肢天池
            { x: 0.1929, y: 0.7305 }  // 胸腹天池（已整合）
        ],
        '俞府': [
            { x: 0.8520, y: 0.7733 }, // 上肢俞府
            { x: 0.1684, y: 0.7910 }  // 胸腹俞府（已整合）
        ],
        '氣戶': [
            { x: 0.8624, y: 0.7733 }, // 上肢氣戶
            { x: 0.1822, y: 0.7944 }  // 胸腹氣戶（已整合）
        ],
        '雲門': [
            { x: 0.8761, y: 0.7727 }, // 上肢雲門
            { x: 0.1965, y: 0.8006 }  // 胸腹雲門（已整合）
        ],
        '華蓋': [
            { x: 0.8368, y: 0.7576 }, // 上肢華蓋
            { x: 0.1529, y: 0.7756 }  // 胸腹華蓋（已整合）
        ],
        '彧中': [
            { x: 0.8436, y: 0.7576 }, // 上肢彧中
            { x: 0.1686, y: 0.7756 }  // 胸腹彧中（已整合）
        ],
        '庫房': [
            { x: 0.8553, y: 0.7576 }, // 上肢庫房
            { x: 0.1836, y: 0.7774 }  // 胸腹庫房（已整合）
        ],
        '中府': [
            { x: 0.8681, y: 0.7565 }, // 上肢中府
            { x: 0.1968, y: 0.7839 }  // 胸腹中府（已整合）
        ],
        '紫宮': [
            { x: 0.8305, y: 0.7421 }, // 上肢紫宮
            { x: 0.1529, y: 0.7593 }  // 胸腹紫宮（已整合）
        ],
        '天谿': [
            { x: 0.8514, y: 0.7104 }, // 上肢天溪
            { x: 0.1989, y: 0.7336 }  // 胸腹天溪（已整合）
        ],
        ...
        '氣衝': [{ x: 0.8268, y: 0.5011 }],
        '居髎': [{ x: 0.8546, y: 0.5081 }],
        '環跳': [{ x: 0.8792, y: 0.4902 }],
        '輒筋': [{ x: 0.8819, y: 0.7020 }],
        '淵腋': [{ x: 0.8905, y: 0.7055 }],
        '大包': [{ x: 0.8870, y: 0.6819 }],
        '中庭': [{ x: 0.8170, y: 0.6924 }],
        '步廊': [{ x: 0.8230, y: 0.6918 }],
        '乳根': [{ x: 0.8346, y: 0.6883 }],
        '食竇': [{ x: 0.8483, y: 0.6922 }],
        '鳩尾': [{ x: 0.8155, y: 0.6784 }],
        '巨闕': [{ x: 0.8145, y: 0.6656 }],
        '幽門': [{ x: 0.8178, y: 0.6660 }],
        '不容': [{ x: 0.8236, y: 0.6662 }],
        '期門': [{ x: 0.8344, y: 0.6664 }],
        '上脘': [{ x: 0.8125, y: 0.6527 }],
        '腹通谷': [{ x: 0.8164, y: 0.6527 }],
        '承滿': [{ x: 0.8232, y: 0.6523 }],
        '日月': [{ x: 0.8344, y: 0.6525 }],
        '中脘': [{ x: 0.8120, y: 0.6387 }],
        '陰都': [{ x: 0.8149, y: 0.6394 }],
        '梁門': [{ x: 0.8229, y: 0.6389 }],
        '建里': [{ x: 0.8116, y: 0.6252 }],
        '石關': [{ x: 0.8148, y: 0.6254 }],
        '關門': [{ x: 0.8229, y: 0.6265 }],
        '腹哀': [{ x: 0.8344, y: 0.6267 }],
        '下脘': [{ x: 0.8107, y: 0.6112 }],
        '商曲': [{ x: 0.8143, y: 0.6112 }],
        '太乙': [{ x: 0.8223, y: 0.6118 }],
        '章門': [{ x: 0.8576, y: 0.6116 }],
        '京門': [{ x: 0.8697, y: 0.6103 }],
        '水分': [{ x: 0.8110, y: 0.5974 }],
        '滑肉門': [{ x: 0.8221, y: 0.5981 }],
        '神闕': [{ x: 0.8107, y: 0.5832 }],
        '育俞': [{ x: 0.8146, y: 0.5836 }],
        '天樞': [{ x: 0.8215, y: 0.5845 }],
        '大橫': [{ x: 0.8346, y: 0.5843 }],
        '帶脈': [{ x: 0.8571, y: 0.5856 }],
        '陰交': [{ x: 0.8119, y: 0.5662 }],
        '中注': [{ x: 0.8152, y: 0.5666 }],
        '外陵': [{ x: 0.8211, y: 0.5662 }],
        '氣海': [{ x: 0.8125, y: 0.5572 }],
        '腹結': [{ x: 0.8352, y: 0.5611 }],
        '石門': [{ x: 0.8127, y: 0.5491 }],
        '四滿': [{ x: 0.8157, y: 0.5493 }],
        '大巨': [{ x: 0.8203, y: 0.5493 }],
        '關元': [{ x: 0.8134, y: 0.5324 }],
        '氣穴': [{ x: 0.8164, y: 0.5322 }],
        '水道': [{ x: 0.8206, y: 0.5319 }],
        '五樞': [{ x: 0.8349, y: 0.5332 }],
        '維道': [{ x: 0.8322, y: 0.5245 }],
        '中極': [{ x: 0.8149, y: 0.5140 }],
        '大赫': [{ x: 0.8184, y: 0.5143 }],
        '歸來': [{ x: 0.8221, y: 0.5149 }],
        '府捨': [{ x: 0.8283, y: 0.5151 }],
        '曲骨': [{ x: 0.8202, y: 0.4965 }],
        '橫骨': [{ x: 0.8233, y: 0.4978 }],
