...
(function() {
    ...
    const ACUPOINT_COORDS = {
        ...
        '頷厭': [
            { x: 0.8604, y: 0.9203 }, // 原 "頜厭"
            { x: 0.1778, y: 0.9326 }  // 原 "頷厭"
        ],
        '中衝': [
            { x: 0.7551, y: 0.9727 },
            { x: 0.2867, y: 0.4193 }
        ...
        '神庭': [{ x: 0.8367, y: 0.9356 }],
        '正營': [{ x: 0.8627, y: 0.9393 }],
        '承靈': [{ x: 0.8735, y: 0.9397 }],
        '頭維': [{ x: 0.8582, y: 0.9275 }],
        '絡卻': [{ x: 0.8882, y: 0.9367 }],
        '後頂': [{ x: 0.8981, y: 0.9315 }],
        '陽白': [{ x: 0.8370, y: 0.9133 }],
        '率谷': [{ x: 0.8770, y: 0.9136 }],
        '天衝': [{ x: 0.8825, y: 0.9140 }],
        '強間': [{ x: 0.9052, y: 0.9094 }],
        '浮白': [{ x: 0.8873, y: 0.8978 }],
        '腦戶': [{ x: 0.9040, y: 0.8872 }],
        '頭竅陰': [{ x: 0.8882, y: 0.8800 }],
        '風池': [{ x: 0.8908, y: 0.8638 }],
        '四白': [{ x: 0.8364, y: 0.8749 }],
        '顴髎': [{ x: 0.8430, y: 0.8673 }],
        '下關': [{ x: 0.8574, y: 0.8708 }],
        '聽會': [{ x: 0.8669, y: 0.8710 }],
        '翳風': [{ x: 0.8744, y: 0.8605 }],
        '巨髎': [{ x: 0.8361, y: 0.8614 }],
        '地倉': [{ x: 0.8362, y: 0.8511 }],
        '頰車': [{ x: 0.8604, y: 0.8453 }],
        '天容': [{ x: 0.8693, y: 0.8442 }],
        '天牖': [{ x: 0.8806, y: 0.8461 }],
        '天柱': [{ x: 0.8881, y: 0.8481 }],
        '大迎': [{ x: 0.8510, y: 0.8372 }],
        '素髎': [{ x: 0.8224, y: 0.8690 }],
        '兌端': [{ x: 0.8271, y: 0.8529 }],
        '承漿': [{ x: 0.8304, y: 0.8402 }],
        '廉泉': [{ x: 0.8447, y: 0.8164 }],     
