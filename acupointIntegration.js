...
(function() {
    ...
    const ACUPOINT_COORDS = {
        ...
        '懸厘': [{ x: 0.8657, y: 0.9044 }],
        '曲鬢': [{ x: 0.8685, y: 0.8983 }],
        '完骨': [{ x: 0.8860, y: 0.8620 }],
        '本神': [{ x: 0.8520, y: 0.9297 }],
        '頭臨泣': [{ x: 0.8472, y: 0.9308 }],
        '尺澤': [{ x: 0.7580, y: 0.7591 }],
        '曲澤': [{ x: 0.7476, y: 0.7434 }],
        '少海': [{ x: 0.7377, y: 0.7300 }],
        '青靈': [{ x: 0.7560, y: 0.7239 }],
        '天泉': [{ x: 0.7996, y: 0.7324 }],
        '迎香': [{ x: 0.8335, y: 0.8668 }],
        '口禾髎': [{ x: 0.8304, y: 0.8591 }],
        '承泣': [{ x: 0.8364, y: 0.8821 }],
        '聽宮': [{ x: 0.8673, y: 0.8781 }],
        '攢竹': [{ x: 0.8313, y: 0.8985 }],
        '眉衝': [{ x: 0.8406, y: 0.9338 }],
        '曲差': [{ x: 0.8439, y: 0.9323 }],
        '五處': [{ x: 0.8460, y: 0.9363 }],
        '承光': [{ x: 0.8598, y: 0.9439 }],
        '通天': [{ x: 0.8739, y: 0.9452 }],
        '玉枕': [{ x: 0.8999, y: 0.8877 }],
        '絲竹空': [{ x: 0.8425, y: 0.9021 }],
        '耳和髎': [{ x: 0.8654, y: 0.8932 }],
        '耳門': [{ x: 0.8673, y: 0.8858 }],
        '角孫': [{ x: 0.8773, y: 0.9028 }],
        '顱息': [{ x: 0.8851, y: 0.8884 }],
        '瘈脈': [{ x: 0.8828, y: 0.8703 }],
        '瞳子髎': [{ x: 0.8425, y: 0.8906 }],
        '目窗': [{ x: 0.8552, y: 0.9367 }],
        '腦空': [{ x: 0.8956, y: 0.8871 }],
        '水溝': [{ x: 0.8271, y: 0.8583 }],
        '上星': [{ x: 0.8416, y: 0.9406 }],
        '囟會': [{ x: 0.8525, y: 0.9478 }],
        '前頂': [{ x: 0.8688, y: 0.9526 }],
        '風府': [{ x: 0.8962, y: 0.8620 }],
        '啞門': [{ x: 0.8929, y: 0.8539 }],
        '上關': [{ x: 0.8573, y: 0.8854 }],
        '頜厭': [{ x: 0.8604, y: 0.9203 }],
        '中衝': [{ x: 0.7551, y: 0.9727 }],
        '少府': [{ x: 0.7381, y: 0.9065 }],
        '勞宮': [{ x: 0.7517, y: 0.9065 }],
        '少商': [{ x: 0.7847, y: 0.9113 }],
        '魚際': [{ x: 0.7682, y: 0.8849 }],
        '神門': [{ x: 0.7348, y: 0.8707 }],
        '陰郄': [{ x: 0.7335, y: 0.8648 }],
        '通里': [{ x: 0.7329, y: 0.8593 }],
        '靈道': [{ x: 0.7315, y: 0.8539 }],
        '大陵': [{ x: 0.7438, y: 0.8689 }],
        '太淵': [{ x: 0.7535, y: 0.8676 }],
        '經渠': [{ x: 0.7518, y: 0.8571 }],
        '列缺': [{ x: 0.7527, y: 0.8501 }],
        '內關': [{ x: 0.7407, y: 0.8473 }],
        '間使': [{ x: 0.7399, y: 0.8163 }],
        '郄門': [{ x: 0.7384, y: 0.8163 }],
        '孔最': [{ x: 0.7506, y: 0.7988 }],
        ...
        '絡卻': [{ x: 0.4630, y: 0.9703 }],
        '承靈': [{ x: 0.4721, y: 0.9701 }],
        '強間': [{ x: 0.4519, y: 0.9353 }],
        '天衝': [{ x: 0.4826, y: 0.9430 }],
        '腦戶': [{ x: 0.4521, y: 0.9128 }],
        '玉枕': [{ x: 0.4599, y: 0.9126 }],
        '腦空': [{ x: 0.4650, y: 0.9137 }],
        '浮白': [{ x: 0.4785, y: 0.9246 }],
        '角孫': [{ x: 0.4848, y: 0.9242 }],
        '頭竅陰': [{ x: 0.4767, y: 0.9115 }],
        '顱息': [{ x: 0.4821, y: 0.9104 }],
        '風府': [{ x: 0.4525, y: 0.8910 }],
        '風池': [{ x: 0.4645, y: 0.8894 }],
        '完骨': [{ x: 0.4695, y: 0.8916 }],
        '瘛脈': [{ x: 0.4788, y: 0.8973 }],
        '翳風': [{ x: 0.4758, y: 0.8875 }],
        '啞門': [{ x: 0.4525, y: 0.8790 }],
        '天柱': [{ x: 0.4590, y: 0.8667 }],
        '天牖': [{ x: 0.4706, y: 0.8667 }],
