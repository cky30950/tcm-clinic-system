...
(function() {
    ...
    const ACUPOINT_COORDS = {
        '府舍': { x: 0.1830, y: 0.5396 },
        '衝門': { x: 0.1780, y: 0.5313 },
        '周榮': { x: 0.1976, y: 0.7973 },
        '胸鄉': { x: 0.1980, y: 0.7505 },
        '天池': { x: 0.1926, y: 0.7305 },
        '天溪': { x: 0.1987, y: 0.7336 },
        '食竇': { x: 0.1993, y: 0.7170 },
        '肩髃': { x: 0.2250, y: 0.7926 },
        '天泉': { x: 0.2224, y: 0.7170 },
        '天府': { x: 0.2309, y: 0.7090 },
        '俠白': { x: 0.2326, y: 0.6987 },
        '急脈': { x: 0.1711, y: 0.5144 },
        '急脈': { x: 0.1711, y: 0.5144 },
        '急脈': { x: 0.1711, y: 0.5144 },
        '急脈': { x: 0.1711, y: 0.5144 },
        '急脈': { x: 0.1711, y: 0.5144 },
        '急脈': { x: 0.1711, y: 0.5144 },
        '陰廉': { x: 0.1667, y: 0.5022 },
        '足五里': { x: 0.1667, y: 0.4890 },
        '缺盆': { x: 0.1815, y: 0.8059 },
        '氣戶': { x: 0.1820, y: 0.7944 },
        '庫房': { x: 0.1834, y: 0.7776 },
        '屋翳': { x: 0.1845, y: 0.7607 },
        '膺窗': { x: 0.1854, y: 0.7451 },
        '乳中': { x: 0.1852, y: 0.7263 },
        '乳根': { x: 0.1852, y: 0.7124 },
        '期門': { x: 0.1852, y: 0.6941 },
        '腹哀': { x: 0.1835, y: 0.6431 },
        '章門': { x: 0.1897, y: 0.6277 },
        '大橫': { x: 0.1832, y: 0.6006 },
        '腹結': { x: 0.1834, y: 0.5818 },
        ...
        '不容': { x: 0.1679, y: 0.6843 },
        '承滿': { x: 0.1677, y: 0.6709 },
        '梁門': { x: 0.1677, y: 0.6570 },
        '關門': { x: 0.1677, y: 0.6436 },
        '太乙': { x: 0.1679, y: 0.6299 },
        '滑肉門': { x: 0.1677, y: 0.6155 },
        '天樞': { x: 0.1677, y: 0.6013 },
        '外陵': { x: 0.1674, y: 0.5867 },
        '大巨': { x: 0.1674, y: 0.5713 },
        '水道': { x: 0.1674, y: 0.5559 },
        '歸來': { x: 0.1671, y: 0.5410 },
        '氣衝': { x: 0.1669, y: 0.5281 },
