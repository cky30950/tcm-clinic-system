            ...
            try {
                ...
                <div class="mt-6 pt-6 border-t border-gray-200">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <div class="font-medium text-gray-700 mb-2">有效套票</div>
                            <div class="space-y-2">
                                ${sortedValid.map(pkg => {
                                    ...
                                    const expDate = new Date(pkg.expiresAt);
                                    // 判斷是否即將到期
                                    const soon = expDate <= soonThreshold;
                                    const containerClasses = soon ? 'bg-red-50 border border-red-200' : 'bg-purple-50 border border-purple-200';
                                    const nameClass = soon ? 'text-red-700' : 'text-purple-900';
                                    const statusClass = soon ? 'text-red-600' : 'text-gray-600';
                                    const usesClass = soon ? 'text-red-700' : 'text-gray-800';
                                    return `
                        ...
                        <div>
                            <div class="font-medium text-gray-700 mb-2">失效套票</div>
                            <div class="space-y-2">
...
function createAppointmentRow(appointment, patient, index) {
    ...
    return `
        <tr class="hover:bg-gray-50">
            ...
            <td class="px-4 py-3 text-sm w-full">
                <!--
