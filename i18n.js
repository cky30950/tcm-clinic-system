...
window.translations = {
    ...
    (function() {
        ...
        const dynamicTranslations = {
            ...
            '匯入失敗！': 'Import failed!'
            ,
            // Added translations for dynamic showToast and confirm messages
            '病人 ': 'Patient ',
            ' 已進入候診中，請準備診症。': ' has entered the waiting room. Please prepare for consultation.',
            '無法確認到達！病人 ': 'Cannot confirm arrival! Patient ',
            ' 目前狀態為「': ' is currently in status "',
            '」，只能對「已掛號」的病人確認到達。': '", only registered patients can be confirmed as arrived.',
            ' 已確認到達，進入候診狀態！': ' has been marked as arrived and moved to waiting status!',
            '已移除 ': 'Removed ',
            ' 的掛號記錄': ' registration record',
            '無法開始診症！病人 ': 'Cannot start consultation! Patient ',
            '」，只能對「已掛號」或「候診中」的病人開始診症。': '", only registered or waiting patients can start consultation.',
            ' 已自動確認到達': ' has been automatically marked as arrived',
            '已結束 ': 'Ended ',
            ' 的診症': ' consultation',
            '開始為 ': 'Start consultation for ',
            ' 診症': ' consultation',
            '您目前正在為 ': 'You are currently consulting ',
            ' 診症。': '.',
            '是否要結束該病人的診症並開始為 ': "Do you want to end that patient's consultation and start a consultation for ",
            ' 診症？': '?',
            '注意：': 'Note: ',
            ' 的狀態將改回候診中。': "'s status will be returned to waiting.",
            '確定要刪除': 'Are you sure you want to delete ',
            '「': '"',
            '」嗎？': '"?',
            '」已刪除！': '" has been deleted!',
            '此操作無法復原！': 'This action cannot be undone!',
            '中藥材': 'Herb',
            '方劑': 'Formula',
            '收費項目': 'Billing item',
            '確定要刪除收費項目': 'Are you sure you want to delete the billing item ',
            '收費項目「': 'Billing item "',
            '」已刪除！': '" has been deleted!',
            '匯入備份將覆蓋現有資料，確定要繼續嗎？': 'Importing a backup will overwrite existing data. Are you sure you want to continue?',
            '匯入模板資料將新增資料（不會刪除現有模板庫資料），是否繼續？': 'Importing template data will add new entries (existing templates will not be deleted). Do you wish to continue?',
            '匯入中藥資料將新增資料（不會刪除現有中藥庫資料），是否繼續？': 'Importing herbal data will add new entries (existing herbal library will not be deleted). Do you wish to continue?',
            '確定要刪除此藥方組合嗎？': 'Are you sure you want to delete this prescription combination?',
            '確定要刪除此穴位組合嗎？': 'Are you sure you want to delete this acupoint combination?',
            '確定要刪除此醫囑模板嗎？': 'Are you sure you want to delete this medical advice template?',
            '確定要刪除此診斷模板嗎？': 'Are you sure you want to delete this diagnosis template?',
            '確定要刪除此分類嗎？': 'Are you sure you want to delete this category?',
            '掛號中': 'Registered',
            '候診中': 'Waiting',
            '診症中': 'Consulting',
            '已完成': 'Completed'
            ...
            ' 次': ' uses left',
            '套票「': 'Package "',
            '」購買失敗': '" purchase failed',
            '使用套票失敗：': 'Failed to use package: ',
            '不明錯誤': 'Unknown error',
            '歡迎回來，': 'Welcome back, ',
            '！': '!',
            '無法進行掛號！您目前正在為 ': 'Cannot register! You are currently treating ',
            ' 診症中...請先結束或暫停診症。': ' in consultation... Please end or pause the current consultation first.',
            '無法進行掛號！病人 ': 'Cannot register! Patient ',
            ' 已掛號給 ': ' is already registered with ',
            ' 醫師！': ' doctor!'
        };
