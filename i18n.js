...
window.translations = {
    ...
    "zh-cn": {
        ...
        "啟動攝影機中…": "启动摄影机中…",
        "拍照失敗，請重試": "拍照失败，请重试",
        "此瀏覽器不支援網頁攝影機，已改開系統相機或檔案選擇": "此浏览器不支援网页摄影机，已改开系统相机或档案选择",
        "必須透過 HTTPS 連線才能使用攝影機，已改開系統相機或檔案選擇": "必须透过 HTTPS 连线才能使用摄影机，已改开系统相机或档案选择",
        "無法啟用攝影機（未授權或未偵測到裝置），已改開系統相機或檔案選擇": "无法启用摄影机（未授权或未侦测到装置），已改开系统相机或档案选择",
        "手機拍照": "手机拍照",
        "產生連結中…": "产生连结中…",
        "等待手機掃碼連線…": "等待手机扫码连线…",
        "產生連結失敗": "产生连结失败",
        "拍照連結已過期，請按「重新產生」": "拍照连结已过期，请按「重新产生」",
        "連結有效期限": "连结有效期限",
        "分鐘": "分钟",
        "已從手機收到": "已从手机收到",
        "張照片，可繼續拍攝": "张照片，可继续拍摄",
    ...
    en: {
        ...
        "本次診症": "This visit",
        "過往醫學報告": "Past medical reports",
        "可查看過往報告": "Past reports available",
        "顯示": "Show",
        ...
        "重拍": "Retake",
        "使用照片": "Use photo",
        "啟動攝影機中…": "Starting camera…",
        "拍照失敗，請重試": "Capture failed, please try again",
        "此瀏覽器不支援網頁攝影機，已改開系統相機或檔案選擇": "This browser does not support in-page camera; opening the system camera or file picker instead.",
        "必須透過 HTTPS 連線才能使用攝影機，已改開系統相機或檔案選擇": "Camera access requires an HTTPS connection; opening the system camera or file picker instead.",
        "無法啟用攝影機（未授權或未偵測到裝置），已改開系統相機或檔案選擇": "Cannot access the camera (permission denied or no device found); opening the system camera or file picker instead.",
        "手機拍照": "Phone capture",
        "產生連結中…": "Generating link…",
        "等待手機掃碼連線…": "Waiting for the phone to connect…",
        "產生連結失敗": "Failed to generate link",
        "拍照連結已過期，請按「重新產生」": "The capture link has expired. Tap “Regenerate”.",
        "連結有效期限": "Link valid for",
        "分鐘": "min",
        "已從手機收到": "Received from phone:",
        "張照片，可繼續拍攝": "photo(s). You can keep shooting.",
        "已過期": "Expired",
        "連結已複製": "Link copied",
        "請手動選擇網址複製": "Please select the URL manually to copy"
    }
};
